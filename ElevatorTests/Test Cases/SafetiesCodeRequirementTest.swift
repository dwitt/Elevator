...
class SafetiesCodeRequirementTest: XCTestCase {
  ...
  func testStoppingDistance_atLowSpeed() {
    safeties!.governorTrippingSpeed = Measurement(value:0.5,units:.metric)
    safeties!.maximumGovernorTrippingSpeed = Measurement(value:1.0,units:.metric)
    ...
    safeties!.governorTrippingSpeed = Measurement(value: 1.0, units: .metric)
    safeties!.maximumGovernorTrippingSpeed = Measurement(value: 0.5, units: .metric)
    ...
    safeties!.governorTrippingSpeed = Measurement(value:125, units:.imperial)
    safeties!.maximumGovernorTrippingSpeed = Measurement(value: 200, units: .imperial)
    safeties!.useGovernorTrippingSpeedForStoppingDistance = true
    minimumStoppingDistnce = safeties!.minimumStoppingDistance
    maximumStoppingDistnce = safeties!.maximumStoppingDistance
  ...
  func testTabulatedStoppingDistance() {
    safeties!.governorTrippingSpeed = Measurement(value: 2.9, units: .metric)
    safeties!.maximumGovernorTrippingSpeed = Measurement(value: 1.0, units: .metric)
    safeties!.useGovernorTrippingSpeedForStoppingDistance = true
    ...
    safeties!.governorTrippingSpeed = Measurement(value: 1.0, units: .metric)
    safeties!.maximumGovernorTrippingSpeed = Measurement(value: 2.9, units: .metric)
    safeties!.useGovernorTrippingSpeedForStoppingDistance = false
    ...
    safeties!.governorTrippingSpeed = Measurement(value: 395, units: .imperial)
    safeties!.maximumGovernorTrippingSpeed = Measurement(value: 200, units: .imperial)
    safeties!.useGovernorTrippingSpeedForStoppingDistance = true
    minimumStoppingDistance = safeties!.minimumStoppingDistance
    maximumStoppingDistance = safeties!.maximumStoppingDistance
    ...
    safeties!.governorTrippingSpeed = Measurement(value: 200, units: .imperial)
    safeties!.maximumGovernorTrippingSpeed = Measurement(value: 395, units: .imperial)
    safeties!.useGovernorTrippingSpeedForStoppingDistance = false
    minimumStoppingDistance = safeties!.minimumStoppingDistance
    maximumStoppingDistance = safeties!.maximumStoppingDistance
    XCTAssertEqual(minimumStoppingDistance, 8)
  ...
  func testInterpolatedStoppingDistance() {
    safeties!.governorTrippingSpeed = Measurement(value: 3, units: .metric)
    safeties!.maximumGovernorTrippingSpeed = Measurement(value: 1.0, units: .metric)
    safeties!.useGovernorTrippingSpeedForStoppingDistance = true
    var minimumStoppingDistance = safeties!.minimumStoppingDistance
    var maximumStoppingDistance = safeties!.maximumStoppingDistance
    ...
    safeties!.governorTrippingSpeed = Measurement(value: 1.0, units: .metric)
    safeties!.maximumGovernorTrippingSpeed = Measurement(value: 3, units: .metric)
    safeties!.useGovernorTrippingSpeedForStoppingDistance = false
    minimumStoppingDistance = safeties!.minimumStoppingDistance
    maximumStoppingDistance = safeties!.maximumStoppingDistance
    XCTAssertEqual(minimumStoppingDistance, 460)
    ...
    safeties!.governorTrippingSpeed = Measurement(value: 425, units: .imperial)
    safeties!.maximumGovernorTrippingSpeed = Measurement(value: 200, units: .imperial)
    safeties!.useGovernorTrippingSpeedForStoppingDistance = true
    minimumStoppingDistance = safeties!.minimumStoppingDistance
    maximumStoppingDistance = safeties!.maximumStoppingDistance
    ...
    safeties!.governorTrippingSpeed = Measurement(value: 200, units: .imperial)
    safeties!.maximumGovernorTrippingSpeed = Measurement(value: 425, units: .imperial)
    safeties!.useGovernorTrippingSpeedForStoppingDistance = false
    minimumStoppingDistance = safeties!.minimumStoppingDistance
    maximumStoppingDistance = safeties!.maximumStoppingDistance
    XCTAssertEqual(minimumStoppingDistance, 9)
  ...
  func testStoppingDistance_atHighSpeed() {
    safeties!.governorTrippingSpeed = Measurement(value:14,units:.metric)
    safeties!.maximumGovernorTrippingSpeed = Measurement(value:10,units:.metric)
    safeties!.useGovernorTrippingSpeedForStoppingDistance = true
    var minimumStoppingDistance = safeties!.minimumStoppingDistance
    var maximumStoppingDistance = safeties!.maximumStoppingDistance
    ...
    safeties!.governorTrippingSpeed = Measurement(value: 10, units: .metric)
    safeties!.maximumGovernorTrippingSpeed = Measurement(value: 14, units: .metric)
    safeties!.useGovernorTrippingSpeedForStoppingDistance = false
    minimumStoppingDistance = safeties!.minimumStoppingDistance
    maximumStoppingDistance = safeties!.maximumStoppingDistance
    XCTAssertEqual(minimumStoppingDistance, 9984)
    ...
    safeties!.governorTrippingSpeed = Measurement(value:2600, units:.imperial)
    safeties!.maximumGovernorTrippingSpeed = Measurement(value: 1000, units: .imperial)
    safeties!.useGovernorTrippingSpeedForStoppingDistance = true
    minimumStoppingDistance = safeties!.minimumStoppingDistance
    maximumStoppingDistance = safeties!.maximumStoppingDistance
    ...
    safeties!.governorTrippingSpeed = Measurement(value: 1000, units: .imperial)
    safeties!.maximumGovernorTrippingSpeed = Measurement(value: 2600, units: .imperial)
    safeties!.useGovernorTrippingSpeedForStoppingDistance = false
    minimumStoppingDistance = safeties!.minimumStoppingDistance
    maximumStoppingDistance = safeties!.maximumStoppingDistance
    XCTAssertEqual(minimumStoppingDistance, 349)
